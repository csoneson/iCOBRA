...
Accessor and replacement functions for the `fdrnbrcurve` slot in a
...
- value:
  ...
  observed FDR vs number of features called positive for each method and
  each stratification level.

## Value

The accessor function returns a data frame giving information necessary
to generate curves of observed FDR vs number of features called positive
