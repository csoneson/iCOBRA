...
#' IBRAPerformance object and constructor
#'
...
#' @param fdrnbrcurve A data frame containing observed FDR and number of features
...
#' @param fpc A data frame containing observed numbers of false positive findings
