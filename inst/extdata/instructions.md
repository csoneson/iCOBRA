...
- **Select column containing binary truth**: The name of the column in the truth text file or the provided `IBRAData` object that contains the binary truth (classification) for the features.
- **Select column containing binary truth**: The name of the column in the truth text file or the provided `IBRAData` object that contains the continuous truth for the features.
...
- **Download Rdata**: Download the `IBRAPlot` object containing all results needed for plotting (see the `IBRA` R package for details).
